...
namespace gdk {
    template<arithmetic_component T> constexpr vector2<T> vector2<T>::min(const vector2<T> &a, const vector2<T> &b) {
        return {std::min(a.x, b.x), std::min(a.y, b.y)};
    }

    template<arithmetic_component T> constexpr vector2<T> vector2<T>::max(const vector2<T> &a, const vector2<T> &b) {
    ...
    template<arithmetic_component component_type> template<class other_component_type>
    ...
    template<arithmetic_component T> const vector2<T> vector2<T>::down  = { 0,-1};
    template<arithmetic_component T> const vector2<T> vector2<T>::left  = {-1, 0};
    template<arithmetic_component T> const vector2<T> vector2<T>::one   = { 1, 1};
    template<arithmetic_component T> const vector2<T> vector2<T>::right = { 1, 0};
    template<arithmetic_component T> const vector2<T> vector2<T>::up    = { 0, 1};
    template<arithmetic_component T> const vector2<T> vector2<T>::zero  = { 0, 0};
}
